...
class CustomerServiceTest {
    ...
    void getCustomer() {
        ...
        Customer customer = new Customer(
                (long) id, "Alex", "alex@hmail.com", "password", 19,
                Gender.MALE);
    ...
    void addCustomer() {
       ...
       String email = "alex@hmail.com";
        ...
        assertThat(capturedCustomer.getId()).isEqualTo(0L); // Update this assertion
    ...
    void canUpdateAllCustomersProperties() {
        // Given
        int id = 10;
        Customer customer = new Customer((long) id, "Alex", "alex@gmail.com", "password", 19, Gender.MALE);
        when(customerDao.selectCustomerById(id)).thenReturn(Optional.of(customer));
